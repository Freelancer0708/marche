            ...
            <div class="cnt02-inner mw-960 mx-auto d-flex flex-column align-items-start align-items-start mt100">
                ...
                <article class="cnt02-list d-flex flex-column align-items-start align-items-start w-100">
                    <div class="cnt02-category d-flex justify-content-between align-items-center  w-100">
                        <a href="<?php echo home_url(); ?>/news/" class="news-cat01 current d-flex justify-content-center align-items-center f_12 gray text-center">全て</a>
                        <a href="<?php echo home_url(); ?>/news/category/notice/" class="news-cat02 d-flex justify-content-center align-items-center f_12 gray text-center">お知らせ</a>
                        <a href="<?php echo home_url(); ?>/news/category/online-marche/" class="news-cat03 d-flex justify-content-center align-items-center f_12 gray text-center">
                            オンライン<br>
                            マルシェ
                        </a>
                        <a href="<?php echo home_url(); ?>/news/category/suns-marche/" class="news-cat04 d-flex justify-content-center align-items-center f_12 gray text-center">
                            太陽の<br>
                            マルシェ
                        </a>
                        <a href="<?php echo home_url(); ?>/news/category/yokohama-kitanaka-marche/" class="news-cat05 d-flex justify-content-center align-items-center f_12 gray text-center">
                            横浜北仲<br>
                            マルシェ
                        </a>
                        <a href="<?php echo home_url(); ?>/news/category/isogo-marche/" class="news-cat06 d-flex justify-content-center align-items-center f_12 gray text-center">
                            いそご丘の上<br>
                            マルシェ
                        </a>
                        ...
                        <a href="<?php echo home_url(); ?>/news/category/other-marche/" class="news-cat07 d-flex justify-content-center align-items-center f_12 gray text-center">
                            その他の<br>
                            マルシェ
                        </a>
                    </div>
                    ...
                    <?php 
    $term      = get_the_category(); //指定されたタクソノミーのタームを取得
...
?>
                            <p class="cnt02-item-cat <?php echo $cats[0]->slug;  ?> f_16 ls_0 gray ms-auto pl10 nohover"><?php if($cats[0]->slug == "notice"): ?>
                                お知らせ
